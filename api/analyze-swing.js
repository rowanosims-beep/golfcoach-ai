...
2. Your scores MUST be spread across at least a 15 point range total — if your highest score is 72, your lowest must be 57 or lower
3. Identify the golfer's strongest metric and their weakest metric — these should be the furthest apart in score
4. Most recreational golfers score between 55-75 overall. Use this range but spread the individual metrics within it
5. Do not cluster scores together — a spread like 72, 65, 58, 63 is correct. A cluster like 68, 70, 67, 69 is wrong
6. If two metrics genuinely look similar, still separate them by at least 5 points based on which looks slightly better
...
Status values must match scores: good if score 65 or higher, warn if 45-64, bad if under 45.`
  });
